...
class LapHoSoTddfController extends Controller
{
    ...
    public function suadoituong (Request $request){
        ...
        if(isset($inputs['id'])){
            $id = $inputs['id'];
            $model = laphosotddf::findOrFail($id);
    ...
    public function updatedt (Request $request){
        ...
        if(isset($inputs['id'])) {
            $id = $inputs['id'];
            $modelttp = laphosotddf::findOrFail($id);
            $modelttp->madt = $inputs['madt'];
            $modelttp->tendanhhieutd = $inputs['tendanhhieutd'];
            $modelttp->save();

            $model = laphosotddf::where('kihieudhtd', $inputs['kihieudhtd'])
                ->get();
            $result['message'] = '<div class="row" id="dsdt">';
            $result['message'] .= '<div class="col-md-12">';
            $result['message'] .= '<table class="table table-striped table-bordered table-hover" >';
    ...
    public function delete(Request $request){
        ...
        if(isset($inputs['id'])){
            ...
            $modeldangkytddf = laphosotddf::where('id',$inputs['id'])->first();

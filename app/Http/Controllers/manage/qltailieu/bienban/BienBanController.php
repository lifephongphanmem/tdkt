...
namespace App\Http\Controllers\manage\qltailieu\bienban;

use App\model\manage\qltailieu\qlbienban;
...
class BienBanController extends Controller
{
    public function index(Request $request){
        if(Session::has('admin')){
            ...
            $model = qlbienban::where('madonvi',session('admin')->madonvi)
                ->get();
            return view('manage.qltailieu.qlbienban.index')
                ->with('inputs',$inputs)
                ->with('model',$model)

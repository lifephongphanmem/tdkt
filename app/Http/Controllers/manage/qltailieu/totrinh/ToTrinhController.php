...
namespace App\Http\Controllers\manage\qltailieu\totrinh;

use App\model\manage\qltailieu\qltotrinh;
...
class ToTrinhController extends Controller
{
    public function index(Request $request){
        if(Session::has('admin')){
            ...
            $model = qltotrinh::where('madonvi',session('admin')->madonvi)
                ->get();
            return view('manage.qltailieu.qltotrinh.index')
                ->with('inputs',$inputs)
                ->with('model',$model)

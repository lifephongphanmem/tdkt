...
class CreateQltotrinhTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('qltotrinh', function (Blueprint $table) {
            $table->increments('id');
            $table->string('matotrinh')->unique();

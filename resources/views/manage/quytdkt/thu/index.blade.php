...
@section('content')
    <h3 class="page-title">
        Quản lý danh sách<small>&nbsp;các khoản thu</small>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet box">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <a href="{{url('qldauvao/create')}}" class="btn btn-default btn-sm">
                ...
                <div class="portlet-body">
                    ...
                    <div class="portlet-body">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center" width="30%">Nội dung phiếu thu</th>
   ...
   <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'qldauvao/delete','id' => 'frm_delete'])!!}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title">Đồng ý xóa phiếu thu?</h4>
                </div>

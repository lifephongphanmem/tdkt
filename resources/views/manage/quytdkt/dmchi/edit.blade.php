...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin danh mục chi<small> chỉnh sửa</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'qldmchi/'. $model->id, 'class'=>'horizontal-form','id'=>'update_qldmchi','files'=>true,'enctype'=>'multipart/form-data']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!!Form::text('madmchi', null, array('id' => 'madmchi','class' => 'form-control required', 'readonly'=>'readonly'))!!}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
    ...
    <script type="text/javascript">
        function validateForm(){
            ...
            var validator = $("#update_qldmchi").validate({
                rules: {
                    noidung :"required",
                },
                messages: {

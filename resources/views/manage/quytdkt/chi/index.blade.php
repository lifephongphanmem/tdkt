...
@section('custom-script')
    ...
    <script>
        ...
        $(function(){
            $('#maphieuchi').change(function() {
                var current_path_url = '/qlchihdtdkt?';
                var maphieuchi = '&maphieuchi='+$('#maphieuchi').val();
                var phanloai = '&phanloai='+$('#phanloai').val();
                var url = current_path_url + maphieuchi + phanloai;
...
@section('content')
    <h3 class="page-title">
        Quản lý danh sách<small>&nbsp;các khoản chi</small>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet box">
                @if(session('admin')->sadmin == 'ssa')
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <a href="{{url('qlchihdtdkt/create')}}" class="btn btn-default btn-sm">
                ...
                <div class="portlet-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {!! Form::text('maphieuchi', $inputs['maphieuchi'], ['id' => 'maphieuchi', 'class' => 'form-control']) !!}
                        </div>
                        <!--div class="col-md-6">
   ...
   <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'qlchihdtdkt/delete','id' => 'frm_delete'])!!}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title">Đồng ý xóa phiếu chi?</h4>
                </div>

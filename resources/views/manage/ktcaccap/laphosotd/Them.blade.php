...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue">
                <div class="portlet-body">
                    ...
                    <h4 class="form-section" style="color: #0000ff">Danh sách đối tượng thi đua cho cán nhân</h4>
                    ...
                    <h4 class="form-section" style="color: #0000ff">Danh sách đối tượng thi đua cho tập thể</h4>
                    @if($inputs['trangthai']=='true')
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
        ...
        <div style="text-align: center">
            <a href="{{url('/HoSoThiDua/ThongTin?madonvi='.$model->madonvi)}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
            @if($inputs['trangthai']=='true')
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select2me" name="madonvi_kt" id="madonvi_kt">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label">Đăng ký danh hiệu thi đua</label>
                                <select id="madanhhieutd_kt" name="madanhhieutd_kt" class="form-control js-example-basic-single">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            {!!Form::textarea('tentieuchuandhtd_ltc', null, array('id' => 'tentieuchuandhtd_ltc','class' => 'form-control','rows'=>'3'))!!}
                        </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-offset-4 col-md-3">
                            <div class="md-checkbox">
                                ...
                                <label for="dieukien_ltc">
                                    <span></span><span class="check"></span><span class="box"></span>Đủ điều kiện</label>
                            </div>
                        </div>
                        </div>
                    </div>

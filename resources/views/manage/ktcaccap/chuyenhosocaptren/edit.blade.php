...
@section('content')
    ...
    <!-- END PAGE HEADER-->
    <div class="row">
        {!! Form::model($model, ['method' => 'PATCH', 'url'=>'chuyenhosocaptren/'. $model->id, 'class'=>'horizontal-form','id'=>'edit_cpcn', 'files'=>true,'enctype'=>'multipart/form-data']) !!}
        ...
        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!!Form::text('kihieudhtd',null, array('id' => 'kihieudhtd','class' => 'form-control required', 'readonly'=>'readonly' ))!!}
            ...
            <div style="text-align: center">
                <a href="{{url('chuyenhosocaptren')}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>

...
@section('content')
    <h3 class="page-title">
        Danh sách<small>&nbsp;hồ sơ đăng ký thi đua</small>
    </h3>
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="modal fade" id="back-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url'=>'chuyenhosocaptren/back','method'=>'post' , 'files'=>true,'id' => 'frm_back','class'=>'form-horizontal','enctype'=>'multipart/form-data'])!!}
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>

...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin danh mục phân loại đối tượng<small> thêm mới</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['url'=>'dmphanloaidt', 'id' => 'create_dmphanloaidt', 'class'=>'horizontal-form']) !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required"  name="tenpl" id="tenpl">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
    ...
    <script type="text/javascript">
        function validateForm(){
            ...
            var validator = $("#create_dmphanloaidt").validate({
                rules: {
                    mapl :"required",
                    tenpl :"required",

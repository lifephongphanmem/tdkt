    ...
    <script>
        ...
        $(function(){
            $('#mapl').change(function() {
                var current_path_url = '/dmphanloaidt?';
                var mapl = '&mapl='+$('#mapl').val();
                var phanloai = '&phanloai='+$('#phanloai').val();
                var url = current_path_url + dmphanloaidt + phanloai;
                window.location.href = url;
            });
            $('#phanloai').change(function() {
                var current_path_url = '/dmphanloaidt?';
                var mapl = '&dmphanloaidt='+$('#mapl').val();
                var phanloai = '&phanloai='+$('#phanloai').val();
            ...
            <div class="portlet box">
                @if(session('admin')->level == 'SSA')
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <a href="{{url('dmphanloaidt/create')}}" class="btn btn-default btn-sm">
                ...
                <hr>
                    <div class="portlet-body">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center" width="40%">Tên phân loại</th>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>{{$tt->mapl}}</td>
                            <td class="active">{{$tt->tenpl}}</td>
                            <td style="text-align: left">{{$tt->ghichu}}</td>
                            <td>
                                @if(can('dmphanloaidt','edit'))
                                <a href="{{url('dmphanloaidt/'.$tt->id.'/edit')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
                                @endif
                                    @if(can('dmphanloaidt','delete'))
    ...
    <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'dmphanloaidt/delete','id' => 'frm_delete'])!!}

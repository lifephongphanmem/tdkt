...
@section('content')
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'qldoituongtt/'. $model->id, 'class'=>'horizontal-form','id'=>'update_qldoituongtt','files'=>true,'enctype'=>'multipart/form-data']) !!}
    ...
    <script type="text/javascript">
        function validateForm(){
            ...
            var validator = $("#update_qldoituongtt").validate({
                rules: {
                    tendt :"required",
                    madinhdanh :"required",
                },

...
@section('content')
    <h3 class="page-title">
        Quyết định khen thưởng <small>&nbsp;chỉnh sửa</small>
    </h3>
    <hr>
    <!-- END PAGE HEADER-->
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue">
                <div class="portlet-body">
                    ...
                    <div class="row">
                        {!! Form::input('text', 'maquyetdinh', null, array('id' => 'maquyetdinh', 'class' => 'form-control hidden'))!!}
                        <div class="col-md-6">

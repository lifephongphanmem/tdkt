...
@section('content')
    <h3 class="page-title">
        Danh sách<small>&nbsp; Quyết định khen thưởng</small>
    </h3>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="phanloai" id="phanloai">
                                    <option value="XA" {{($inputs['phanloai'] == 'XA' ? 'selected' : '')}}>Quyết định khen cấp Xã</option>
                                    <option value="HUYEN" {{($inputs['phanloai'] == 'HUYEN' ? 'selected' : '')}}>Quyết định khen cấp Huyện</option>
                                    <option value="TINH" {{($inputs['phanloai'] == 'TINH' ? 'selected' : '')}}>Quyết định khen cấp Tỉnh</option>
                                    <option value="TU" {{($inputs['phanloai'] == 'TU' ? 'selected' : '')}}>Quyết định khen cấp Trung Ương</option>
                                </select>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="back-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'qlquyetdinh','method'=>'post' , 'files'=>true,'id' => 'frm_back','class'=>'form-horizontal','enctype'=>'multipart/form-data'])!!}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>

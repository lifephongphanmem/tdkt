...
@section('content')
    <h3 class="page-title">
        Danh sách<small>&nbsp; quản lý biên bản</small>
    </h3>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="phanloai" id="phanloai">
                                    <option value="XA" {{($inputs['phanloai'] == 'XA' ? 'selected' : '')}}>Cấp Xã</option>
                                    <option value="HUYEN" {{($inputs['phanloai'] == 'HUYEN' ? 'selected' : '')}}>Cấp Huyện</option>
                                    <option value="TINH" {{($inputs['phanloai'] == 'TINH' ? 'selected' : '')}}>Cấp Tỉnh</option>
                                    <option value="TU" {{($inputs['phanloai'] == 'TU' ? 'selected' : '')}}>Cấp Trung Ương</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                            ...
                            <tr>
                                ...
                                <th style="text-align: center" width="10%">Đơn vị nhận</th>

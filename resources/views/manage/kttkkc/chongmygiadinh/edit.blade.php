...
@section('content')
    <h3 class="page-title">
        Danh sách <small>&nbsp;bằng khen chủ tịch UBND tỉnh (tỉnh Hà Bắc cũ) chỉnh sửa</small>
    </h3>
    <hr>
    <!-- END PAGE HEADER-->
    <div class="row">
        {!! Form::model($model, ['method' => 'PATCH', 'url'=>'chongmygiadinh/'. $model->id, 'class'=>'horizontal-form','id'=>'edit_cpcn', 'files'=>true,'enctype'=>'multipart/form-data']) !!}

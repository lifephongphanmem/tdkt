...
@section('content')
    <h3 class="page-title">
        Danh sách <small>&nbsp;khen thưởng kháng chiến chống Mỹ(gia đình) thêm mới</small>
    </h3>
    <hr>
    <!-- END PAGE HEADER-->
    <div class="row">
        {!! Form::open(['url'=>'chongmygiadinh','method'=>'post' , 'files'=>true, 'id' => 'create_cpcn', 'class'=>'horizontal-form', 'enctype'=>'multipart/form-data']) !!}
        ...
        <div class="col-md-12">
            ...
            <div style="text-align: center">
                <a href="{{url('chongmygiadinh')}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>

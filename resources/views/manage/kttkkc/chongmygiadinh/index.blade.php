...
@section('content')
    <h3 class="page-title">
        Danh sách<small>&nbsp;khen thưởng kháng chiến chống Mỹ(gia đình)</small>
    </h3>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        <a href="{{url('chongmygiadinh/create')}}" class="btn btn-default btn-sm">
                            ...
                            @foreach($model as $key => $tt)
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <a href="{{url('chongmygiadinh/'.$tt->id)}}" class="btn btn-default btn-xs mbs" target="_blank"><i class="fa fa-eye"></i>&nbsp;Xem chi tiết</a>
                                        <a href="{{url('chongmygiadinh/'.$tt->id).'/edit'}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
        ...
        <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url'=>'chongmygiadinh/delete','id' => 'frm_delete'])!!}

...
@section('content')
    <h3 class="page-title">
        Danh sách <small>&nbsp;bằng khen thủ tướng (tỉnh Hà Bắc cũ) chỉnh sửa</small>
    </h3>
    <hr>
    <!-- END PAGE HEADER-->
    <div class="row">
        {!! Form::model($model, ['method' => 'PATCH', 'url'=>'ktthutuong/'. $model->id, 'class'=>'horizontal-form','id'=>'edit_cpcn', 'files'=>true,'enctype'=>'multipart/form-data']) !!}
        ...
        <div class="col-md-12">
            ...
            <div style="text-align: center">
                <a href="{{url('ktthutuong')}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>

...
@section('content')
    <h3 class="page-title">
        Danh sách<small>&nbsp;bằng khen thủ tướng (tỉnh Hà Bắc cũ)</small>
    </h3>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        <a href="{{url('ktthutuong/create')}}" class="btn btn-default btn-sm">
                            ...
                            @foreach($model as $key => $tt)
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <a href="{{url('ktthutuong/'.$tt->id)}}" class="btn btn-default btn-xs mbs" target="_blank"><i class="fa fa-eye"></i>&nbsp;Xem chi tiết</a>
                                        <a href="{{url('ktthutuong/'.$tt->id).'/edit'}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
        ...
        <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url'=>'ktthutuong/delete','id' => 'frm_delete'])!!}

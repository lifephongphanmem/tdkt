...
@section('content')
    <h3 class="page-title">
        Danh sách <small>&nbsp;bằng khen chủ tịch UBND tỉnh (tỉnh Hà Bắc cũ) thêm mới</small>
    </h3>
    <hr>
    <!-- END PAGE HEADER-->
    <div class="row">
        {!! Form::open(['url'=>'ktctubnd','method'=>'post' , 'files'=>true, 'id' => 'create_cpcn', 'class'=>'horizontal-form', 'enctype'=>'multipart/form-data']) !!}

...
@section('content')
    <h3 class="page-title">
        Danh sách <small>&nbsp;khen thưởng kháng chiến chống Mỹ(cá nhân) thêm mới</small>
    </h3>
    <hr>
    <!-- END PAGE HEADER-->
    <div class="row">
        {!! Form::open(['url'=>'chongmycanhan','method'=>'post' , 'files'=>true, 'id' => 'create_cpcn', 'class'=>'horizontal-form', 'enctype'=>'multipart/form-data']) !!}

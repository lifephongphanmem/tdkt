...
@section('content')
    ...
    <h3 class="page-title">
       Báo cáo tổng hợp<small>07.02N/BNV-TĐKT</small>
    </h3>
    <!-- END PAGE HEADER-->
<hr>
    <!-- BEGIN DASHBOARD STATS -->
            {!! Form::open(['url'=>'baocao02N','target'=>'_blank' , 'id' => 'frm_bc1', 'class'=>'form-horizontal form-validate']) !!}
            <div class="modal-content">
                <div class="modal-header modal-header-primary">
                    <button type="button" data-dismiss="modal" aria-hidden="true"
                            class="close">&times;</button>
                    <h4 id="modal-header-primary-label" class="modal-title">Báo cáo tổng hợp 02N-BNV-TĐKT</h4>
                </div>

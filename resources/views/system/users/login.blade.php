...
<div class="logo">
	...
	<h2 style="text-transform: uppercase;"><b style="color: #32c5d2">PHẦN MỀM THI ĐUA KHEN THƯỞNG
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
		...
		<p class="form-title"><span style="font-size: 19px">Chào bạn. </span><span style="color: #c9dce9; font-size: 17px">Xin mời đăng nhập</span></p>
		<div class="alert alert-danger display-hide">
			<button class="close" data-close="alert"></button>
			<span>
			Nhập thông tin tài khoản và mật khẩu. </span>
		</div>
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control required" type="text" autocomplete="off" placeholder="Tên đăng nhập" name="username" id="username" autofocus
